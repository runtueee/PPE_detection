...
def test_real_endpoint(endpoint, data):
    ...
    try:
        ...
        response = requests.post(
            f"http://localhost:5000{endpoint}", json=data, headers={"Content-Type": "application/json"}, timeout=30
        )
...
def main():
    ...
    smart_data = {"image": test_image, "frame_count": 1}
