...
'''python split_dataset.py --src "D:/innovaton_competetion/ultralytics-main/css-data" --dst "D:/innovaton_competetion/ultralytics-main/css-data-split" --ratio 0.7 0.2 0.1 --seed 42 --by_scene False'''
...
def main():
    ...
    write_data_yaml(dst_root, nc=len(names_list), names=names_list, train_rel='train/images', val_rel='val/images', test_rel='test/images')
